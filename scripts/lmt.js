(function(){
	...
	ads.lmtfun = Class.extend({
		...
		create:function(){
			    ...
			    data.mwidth = data.mwidth || 20;
			    data.mheight = data.mheight || 200;
			    data.mright = data.mright || "5";
			    data.mbottom = data.mbottom || "5";
			    data.playtime = data.playtime || 5;
			    var cosbuttonh = 57;
			    var cosbuttonw = 20;
				var leftlength ;
				var idTime;
				...
				var closediv = document.createElement('div');
				    ...
				    closediv.style.top = (data.mheight*1+20)+'px';
				    closediv.style.zIndex = '9999';
				    closediv.style.display='none';
				var media = document.createElement('div');
				    media.isclick = false;
					media.style.position = 'absolute';
					media.style.top = getheight(data.height);
					media.style.right = (document.body.clientWidth - data.width)/2 + 'px';
				...
				function divplay(){
					...
					ads.animate(media, {
						right:leftlength,
		                top:media.isclick ? getheight(data.mheight) : getheight(data.height)
		            },{
						duration: 500,
						easing: "easeOutCirc"
					});
